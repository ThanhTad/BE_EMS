...
public class UserController {
    ...
    @GetMapping("/search")
    public ResponseEntity<Page<UserResponseDTO>> searchUsers(@RequestParam("keyword") String keyword, Pageable pageable){
    ...
    public ResponseEntity<UserResponseDTO> findByUsernameOrEmail(@RequestParam("usernameOrEmail") String usernameOrEmail){
